export class CompetitionCreate {
    constructor(public title: string,
                ...
                public register_strategy: object,
                public published: boolean,
                public hidden: boolean,
                public leaderboard_hidden: boolean,
...
export class Competition extends CompetitionCreate {
    ...
    static fromJson(rawJson): Competition {
        return new Competition(
            ...
            rawJson.player_location,
            rawJson.allow_leaderboard,
            rawJson.register_strategy_type,
            rawJson.register_strategy,
            rawJson.published,
            rawJson.hidden,
            rawJson.leaderboard_hidden,
    ...
    constructor(public id: string,
                ...
                public allow_leaderboard: boolean,
                register_strategy_type: number,
